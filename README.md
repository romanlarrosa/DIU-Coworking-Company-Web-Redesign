...
La empresa elegida es [Cubikate], un espacio de coworking y oficina virtual situado en el centro de la ciudad de Granada. Me ha parecido que tienen una localización muy competitiva y una web que en principio parece muy atractiva, y quiero ver si tiene características fácilmente mejorables.
...
Una herramienta interesante para encontrar locales que ofrecen el servicio de oficinas coworking es [Coworking Spain], web desde la cual podemos buscar este tipo de servicio basándonos en la ubicación.

Las empresas que he elgido para comparar sus servicios con los de [Cubikate] son **[ErranT]**, en Granada, y **[LaRaum]** en Madrid.

La elección de estos dos servicios ha sido por presentar características muy diferentes pero que entran dentro de la filosofía de [Cubikate]. Mientras que [ErranT] es una empresa que se enfoca en llegar a un número grande de personas y mantener un espacio con muchos puestos, [LaRaum] ofrece un servicio más "premium" con unos espacios más amplios y una estética más minimalista y elegante, sobre todo porque una de las opciones que ofrece son salas de reuniones y pretenden dar una imagen muy profesional a los usuarios que hagan uso de estas para tener por ejemplo reuniones con clientes potenciales.

Estas dos características principales que señalo en estas dos empresas son características de las que [Cubikate] puede sacar provecho puesto que sus instalaciones le permiten en mayor o menor medida el desarrollo de ambas.
